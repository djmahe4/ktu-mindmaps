...
graph TD
    ...
    D -- Due to Industry Growth/Concentration --> D1(Infrastructure Improvements);
    D -- Due to Industry Growth/Concentration --> D2(Specialized Labor);
    D -- Due to Industry Growth/Concentration --> D3(Ancillary Industries);
```
